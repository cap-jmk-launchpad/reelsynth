...
- **DenoiseOpt (Seam·Opt)** — unsupervised fit of a seam-local periodize stack on joint denoise+shape loss (no labels); frozen θ for fast inference. See `docs/WHITEPAPER_DENOISE_OPT.md`.
